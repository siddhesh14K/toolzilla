...
*Example:* If annual rate is 12%, then r = 12 ÷ 12 ÷ 100 = 0.01

#### Step 2: Calculate Number of Installments
Number of Installments (n) = Loan Tenure in Years × 12

*Example:* For 5 years, n = 5 × 12 = 60 months
...
4. **Calculate step by step:**
   ...
   - Numerator = 50,00,000 × 0.007083 × 5.9966 = 2,12,324
   - Denominator = 5.9966 - 1 = 4.9966
   - EMI = 2,12,324 ÷ 4.9966 = ₹42,494

**Result:** Monthly EMI = ₹42,494
...
**Calculation:**
1. r = 10.5 ÷ 12 ÷ 100 = 0.00875
2. n = 5 × 12 = 60 months
3. EMI = 8,00,000 × 0.00875 × (1.00875)^60 / ((1.00875)^60 - 1)
4. EMI = ₹17,118
...
2. **Enter Loan Details:**
   - Principal amount (₹1,00,000 to ₹10,00,00,000)
...
- Maximum EMI Capacity: ₹40,000
- Includes all loans (home, car, personal)

### EMI Affordability Calculator

**Formula:** Maximum EMI = (Monthly Income - Monthly Expenses) × 0.6
...
**Calculation Example:**
- Original Loan: ₹50,00,000 at 8.5% for 20 years
- EMI: ₹42,494
- Prepayment: ₹5,00,000 after 5 years
- New EMI: ₹35,412 (16% reduction)
- Interest Saved: ₹12,85,000
